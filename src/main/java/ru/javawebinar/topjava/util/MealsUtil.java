...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealWithExceed> makeWithExceedList(List<Meal> list) {
        return list.stream().map(m -> MealsUtil.createWithExceed(m, false)).collect(Collectors.toList());
    }
